"""
Function to generate basis set dimensions for l and n.
Taken from SALTED, source code available at:

https://github.com/andreagrisafi/SALTED/blob/master/src/basis.py
"""
...
def basiset(basis):
    ...
    if basis == "FHI-aims-clusters":
        ...
        raise ValueError(f"Basis set {basis} not known")
